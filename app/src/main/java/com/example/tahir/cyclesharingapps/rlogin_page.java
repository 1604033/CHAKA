...
public class rlogin_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rlogin_page);
        ...
        signup_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(rlogin_page.this, rregistration.class);
    ...
    {
        String url;
        url = "http://sibbir.ourcuet.com/rlogin.php";
        ...
        StringRequest srq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if( response.equals("\nOK")) {
                    ...
                    Intent intent=new Intent(getApplicationContext(),rider_choice.class);
                    startActivity(intent);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(rlogin_page.this, "Sorry! Something went wrong!!!", Toast.LENGTH_SHORT).show();
        ...
        MySingleton.getmInstance(rlogin_page.this).AddToRequestQueue(srq);
    }
