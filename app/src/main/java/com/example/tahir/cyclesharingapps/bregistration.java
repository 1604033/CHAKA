...
public class bregistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bregistration);

        builder = new AlertDialog.Builder(bregistration.this);
    ...
    void insert_data()
    {
        String url = "http://sibbir.ourcuet.com/bregistration.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                builder.setPositiveButton("continue", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent=new Intent(bregistration.this,biker_choice.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(bregistration.this, "Something went wrong, please try again later!", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                reg_map.put("busername", name);
                reg_map.put("bid", id);
                reg_map.put("bhall", hall);
                reg_map.put("bphone", phone);
                reg_map.put("bpassword", password);

                return reg_map;
            }
        };

        MySingleton.getmInstance(bregistration.this).AddToRequestQueue(stringRequest);
    }
}
